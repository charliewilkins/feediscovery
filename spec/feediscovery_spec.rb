...
require_relative '../lib/feediscovery.rb'
...
describe Feediscovery::DiscoverFeedService, :vcr => true do
  ...
  context "#initialize" do
    it "can be instantiated with a string that might be a URL" do
      expect { Feediscovery::DiscoverFeedService.new("slashdot") }.to_not raise_error
    end
    it "can be initialized with a valid url" do
      expect { Feediscovery::DiscoverFeedService.new("http://slashdot.org") }.to_not raise_error
    end
  end
  ...
  describe "#result" do
    ...
    context "when the search term is not a valid URL" do
    ...
    context "when the search term is two words" do
